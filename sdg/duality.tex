...
For example in the Dubuc topos, the object $\neg \neg (x = 0)$ in the base ring $R$ is given by the germs of smooth functions $\mathbb{R} \to \mathbb{R}$ 
at $0$, and not every element of this is nilpotent.
